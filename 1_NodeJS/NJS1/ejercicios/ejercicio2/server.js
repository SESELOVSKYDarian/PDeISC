...
const server = createServer(async (req, res) => {
  ...
  const filas = resultadosEjercicio2
    .map(
      (item) => `
        <article class="card">
          <span>Operacion</span>
    ...
    <body>
      <main class="page">
        <section class="hero">
          ...
          <h1>Ejercicio 2</h1>
          <p>Operaciones calculadas con JavaScript y servidas desde Node.js.</p>
        </section>
...
server.listen(PORT, () => {
  console.log(`Ejercicio 2 disponible en http://127.0.0.1:${PORT}`);
  console.log("Servidor independiente del ejercicio 2.");
});
