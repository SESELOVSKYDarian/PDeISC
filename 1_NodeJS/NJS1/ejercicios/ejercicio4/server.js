...
const server = createServer(async (req, res) => {
  ...
  const filas = resultadosEjercicio4
    .map(
      (item) => `
        <article class="card">
          <span>Modulo calculos.js</span>
    ...
    <body>
      <main class="page">
        <section class="hero">
          ...
          <h1>Ejercicio 4</h1>
          <p>Resultados importados desde el modulo real <code>calculos.js</code>.</p>
        </section>
...
server.listen(PORT, () => {
  console.log(`Ejercicio 4 disponible en http://127.0.0.1:${PORT}`);
  console.log("Servidor independiente del ejercicio 4.");
});
